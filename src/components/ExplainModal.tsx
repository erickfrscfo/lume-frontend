        ...
        <div className="px-6 py-5 max-h-[60vh] overflow-y-auto">
          ...
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-xs text-slate-400 mt-1">O Esnork está gerando uma análise personalizada</p>
            </div>
          )}
          ...
          {data && !isLoading && (
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-500">Análise gerada pelo Esnork com base nos seus dados</span>
              </div>
              ...
              <div className="bg-emerald-50 rounded-xl p-5 border-l-4 border-emerald-400">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-xs font-bold text-emerald-600 uppercase tracking-wide">Recomendação do Esnork</h3>
                </div>
