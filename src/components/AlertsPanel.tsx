        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <h3 className="font-semibold text-gray-900 text-sm">
              CFO AI identificou {summary.total} {summary.total === 1 ? 'insight' : 'insights'}
            </h3>
      ...
      <div className="relative w-full max-w-lg bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-gray-400">
              ...
              <p className="text-sm text-center mt-1">
                Nenhum alerta no momento. O CFO AI está monitorando seus dados continuamente.
              </p>
            </div>
          ) : (
            alerts.map((alert) => {
        ...
        <div className="p-4 border-t bg-gray-50 text-center">
          <p className="text-xs text-gray-400">
            Alertas gerados automaticamente pelo CFO AI • Atualizado a cada upload
          </p>
        </div>
      </div>
    </div>
